        ...
        <div className='w-full bg-white shadow-md py-3'>
            ...
            <div className='flex flex-row mt-1.5 gap-3 items-center mx-4 sm:mx-5 justify-between'>
                <div className='flex flex-row items-center gap-3'>
                    ...
                    <p className='font-["Julius_Sans_One"] text-[20px] sm:text-[32px] text-[#3E4A34] font-thin select-none'>MY DISCUSSIONS</p>
                </div>
            </div>
                ...
                <div className='flex flex-row gap-2 flex-wrap'>
                    {sortButtons.map(({ value, label, icon }) => (
                        <button
                            ...
                            className={`flex flex-row items-center gap-1.5 px-3 sm:px-4 py-1.5 rounded-full transition-all ${
                                sortBy === value

...
const Note_forum_page = () => {
    return (
        <div className='w-full h-full bg-[#EEF2E1] overflow-auto'>
            <div className='flex flex-col w-full h-[150px] max-w-[calc(100%-80px)] mx-[40px] my-[50px] bg-white rounded-[12px] '>
                <div className='flex justify-between flex-row w-full'>
                    <div className='mt-[6px] ml-[12px] flex flex-row justify-center gap-[12px]'>
                ...
                <div className='flex flex-row justify-between'>
                    <div className='flex flex-row items-center gap-[8px] mt-[6px] ml-[12px]'>
                    ...
                    <div className='flex flex-row gap-[18px] mr-[60px] mt-[10px]'>

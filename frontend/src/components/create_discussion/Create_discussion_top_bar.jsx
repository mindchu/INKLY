        ...
        <div className='w-full bg-white shadow-md py-3'>
            <div className='flex flex-row gap-3 items-center mt-2 mx-4 sm:mx-5 justify-between'>
                <div className='flex flex-row items-center gap-3'>
                    ...
                    <BiChat size={28} className='opacity-70 text-[#3E4A34] hidden sm:block' />
                ...
                <button
                    ...
                    className='flex-shrink-0 px-3 sm:w-[200px] h-[36px] sm:h-[40px] rounded-md bg-[#34C759]/70 text-white font-["Inter"] text-[13px] sm:text-[16px] cursor-pointer hover:bg-[#34C759] hover:scale-105 transition-all duration-200'
                >
                    Publish
                </button>
            </div>
